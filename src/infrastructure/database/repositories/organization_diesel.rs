...
use diesel::{RunQueryDsl, SelectableHelper, QueryDsl, OptionalExtension, ExpressionMethods};
...
use crate::{business::repositories::organization_repository::OrganizationRepository, domain::entities::organization::Organization};
...
impl OrganizationRepository for OrganizationDieselRepository {
    ...
    fn get(&self, id:Uuid) -> Result<Option<Organization>,Box<dyn Error>> {
        ...
        let result: Result<Option<OrganizationDiesel>, diesel::result::Error> = organizations::dsl::organizations
            .find(id.to_string())
        ...
        let organization = match organization_opt {
            ...
            Some(organization_schema) => Organization {
                ...
                id: Uuid::parse_str(&organization_schema.id.to_string()).expect("Failed to load uuid"),
    ...
    fn email_exists(&self, email_to_check: &str) -> Result<bool,Box<dyn Error>> {
        ...
        let exists = diesel::
            select(diesel::dsl::
                exists(organizations::dsl::organizations
